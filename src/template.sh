...
#--------------------------------------------------------------------------------------#
# TODO
#   - This is a bash template that covers a large part of the functionality in scripts
#
#--------------------------------------------------------------------------------------#
...
# how to suppress newline in echo: call with $echo "ok [yep] ?" <-- prompt here
echo=/bin/echo
case ${N}$C in
...
test -n "$REMOTEHOST"	|| usage "Error: no remotehost !"
test -n "$GROUP"	|| usage "Error: no group !"
