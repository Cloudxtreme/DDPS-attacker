...
Tvungen sideskift - version 2:
: ``<html><div style="page-break-before: always"> &nbsp;</div></html>``

Tvungen ny linie uden mellemrum:
: Afslut den foregående med en masse mellemrum.


Overstreget tekst:
: ``<s>Det her bliver streget ud</s>`` så det ser sådan ud: <s>Det her bliver streget ud</s>
